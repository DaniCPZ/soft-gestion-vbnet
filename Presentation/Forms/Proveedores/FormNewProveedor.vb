...
Public Class FormNewProveedor
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        proveedorModel.State = EntityState.Added
    ...
    Private Sub FormNewProveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
